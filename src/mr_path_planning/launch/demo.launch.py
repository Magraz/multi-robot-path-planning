...
def generate_launch_description():
    ...
    this_directory = get_package_share_directory("mr_path_planning")
    ...
    declare_stage_cmd = DeclareLaunchArgument(
        "stage", default_value="True", description="Whether run a stage"
    )

    rviz = LaunchConfiguration("rviz")
    declare_rviz_cmd = DeclareLaunchArgument(
        "rviz", default_value="True", description="Whether run a rviz"
    )

    world = LaunchConfiguration("world")
    declare_world = DeclareLaunchArgument(
        "world",
        default_value="cave_three_robots",
    ...
    return LaunchDescription(
        [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    os.path.join(launch_dir, "stage.launch.py")
                ),
